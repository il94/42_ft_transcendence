...
type PropsPrimaryMenuContextual = {
	...
	setSecondaryTop: Dispatch<SetStateAction<number>>,
	secondaryHeight: number
}

function PrimaryMenuContextual({ position, displaySecondary, setSecondaryTop, secondaryHeight } : PropsPrimaryMenuContextual) {
